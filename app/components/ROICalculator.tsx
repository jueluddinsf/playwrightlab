                    ...
                    <div className="bg-gradient-to-br from-zinc-900 to-black border border-white/10 rounded-3xl p-8 relative overflow-hidden">
                        ...
                        <div className="grid gap-6 relative z-10">
                            <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5">
                                ...
                                <div>
                                    <div className="text-sm text-zinc-500">Engineering Hours Saved/Year</div>
                                    <div className="text-2xl font-bold text-white">{savings.hours.toLocaleString()} hrs</div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/5">
                                ...
                                <div>
                                    <div className="text-sm text-zinc-500">Infrastructure Savings</div>
                                    <div className="text-2xl font-bold text-white">${savings.infrastructure.toLocaleString()}</div>
                                </div>
                            </div>

                            <div className="mt-4 pt-6 border-t border-white/10">
                                <div className="text-center">
                                    <div className="text-sm text-zinc-500 mb-2 uppercase tracking-wider">Total Annual Impact</div>
                                    <div className="text-5xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-playwright to-orange">
